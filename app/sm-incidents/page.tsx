...
export default function IncidentsView() {
  const [activityLogs, setActivityLogs] = useState<ActivityLog[]>([
    {
      time: "14:32:15",
      action: "BLOCKED",
      detail: "Data poisoning attempt from 192.168.1.45",
    },
    {
      time: "14:27:42",
      action: "BLOCKED",
      detail: "Prompt injection detected in chat interface",
    },
    {
      time: "14:20:08",
      action: "BLOCKED",
      detail: "Jailbreak pattern matched: DAN variant",
    },
    {
      time: "14:14:33",
      action: "FLAGGED",
      detail: "Suspicious query pattern from 192.168.1.67",
    },
    {
      time: "14:08:19",
      action: "BLOCKED",
      detail: "Adversarial input with unicode manipulation",
    },
    {
      time: "14:02:45",
      action: "ALLOWED",
      detail: "Clean request processed successfully",
    },
    {
      time: "13:58:12",
      action: "BLOCKED",
      detail: "Rate limit exceeded for IP 10.0.0.123",
    },
  ]);
  ...
  const incidents = [
    {
      ...
      description:
        "Multiple sources attempting to inject poisoned training data",
    },
    {
      id: "INC-2024-1046",
      ...
      sources: ["10.0.0.123"],
      description:
        "Systematic attempts to extract system prompts and override instructions",
    },
    {
      id: "INC-2024-1045",
      ...
      description:
        "Coordinated probing to extract model architecture and weights",
    },
    {
      id: "INC-2024-1044",
    ...
    },
    {
      ...
      description:
        "High volume of adversarial inputs designed to cause misclassification",
    },
  ];
  ...
  const handleExport = () => {
    const csv = activityLogs
      .map((log) => `${log.time},${log.action},${log.detail}`)
      .join("\n");
        ...
        <div className="space-y-6 p-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Security incident tracking and forensic analysis
            </p>
          </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Tracked security events and their resolution status
                  </CardDescription>
                </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Real-time firewall activity and decision logs (
            ...
            <CardContent>
              <div className="space-y-2 font-mono text-xs max-h-96 overflow-y-auto">
                <div className="flex gap-4 border-b border-border pb-2 sticky top-0 bg-card">
                  <span className="w-[180px] text-muted-foreground">
                    Timestamp
                  </span>
                  <span className="w-[120px] text-muted-foreground">
                    Action
                  </span>
                ...
                {activityLogs.map((log, i) => (
                  <div
                    key={i}
                    className="flex gap-4 py-1 hover:bg-accent/50 rounded px-2 -mx-2"
                  >
                    <span className="w-[180px] text-muted-foreground">
                      {log.time}
                    </span>
