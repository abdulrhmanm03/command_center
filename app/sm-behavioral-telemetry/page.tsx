...
export default function BehavioralTelemetryView() {
  ...
  const [temporalPatterns, setTemporalPatterns] = useState<TemporalPattern[]>([
    {
      pattern: "Off-hours activity spike",
      detected: "03:00-04:00 UTC",
      confidence: 94,
      type: "time_anomaly",
    },
    {
      pattern: "Sequence gap detected",
      detected: "Session user_8472",
      confidence: 87,
      type: "sequence_gap",
    },
    {
      pattern: "Potential replay attack",
      detected: "user_3391 → user_7721",
      confidence: 76,
      type: "replay",
    },
  ]);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setSessions((prev) =>
        prev.map((session) => ({
          ...session,
          queriesPerMinute: Math.max(
            1,
            session.queriesPerMinute + Math.floor(Math.random() * 10 - 5)
          ),
          burstRate: Math.max(
            1,
            session.burstRate + Math.floor(Math.random() * 4 - 2)
          ),
        }))
      );
    }, 3000);
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Monitor session dynamics and behavioral fingerprints of AI usage
            </p>
          </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Real-time frequency and burst rate of queries per user or
                    process
                  </CardDescription>
                </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Changes in syntax, length, and embedding distance from normal
                  behavior
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {promptVariances.map((variance, idx) => (
                    <div key={idx} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={getStatusColor(variance.status)}
                          className="text-xs"
                        >
                          {variance.status}
                        </Badge>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Sequence and chaining of AI tool use
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Time-of-day anomalies, sequence gaps, and replay patterns
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {temporalPatterns.map((pattern, idx) => (
                    <div key={idx} className="p-3 border rounded-lg space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={getTypeColor(pattern.type)}
                          className="text-xs"
                        >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Spikes suggesting exfiltration or abuse
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                      ...
                      <div className="space-y-1">
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="font-medium">
                            {consumption.tokensUsed.toLocaleString()} tokens
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          <span className="text-muted-foreground">Average</span>
                          <span>
                            {consumption.avgTokens.toLocaleString()} tokens
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          ...
                          >
                            {(
                              (consumption.tokensUsed / consumption.avgTokens -
                                1) *
                              100
                            ).toFixed(1)}
                            %
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Aggregated behavioral patterns forming the fingerprint of AI
                usage
              </CardDescription>
            </CardHeader>
            <CardContent>
