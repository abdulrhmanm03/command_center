...
export default function ModelRegistryView() {
  ...
  const [selectedBaseline, setSelectedBaseline] =
    useState<BehavioralBaseline | null>(null);
  ...
  const [vulnerabilities] = useState<Vulnerability[]>([
    {
      ...
      description:
        "Potential backdoor detected in training data affecting output integrity",
      detected: "1 hour ago",
      status: "open",
    },
    {
      ...
      description:
        "Suspicious weight patterns detected that may indicate tampering",
    ...
    },
    {
      ...
      type: "Shadow AI",
      description:
        "Unmanaged model detected in production without security scanning",
          ...
          if (model.status === "scanning") {
            return {
              ...
              securityScore: Math.min(
                100,
                model.securityScore + Math.random() * 2
              ),
            };
          }
          return model;
  ...
  const handleScanModel = (modelId: string) => {
    setModels((prev) =>
      prev.map((m) =>
        m.id === modelId ? { ...m, status: "scanning" as const } : m
      )
    );
    toast({
      title: "Scan Started",
  ...
  const handleRegisterModel = (modelId: string) => {
    setModels((prev) =>
      prev.map((m) =>
        m.id === modelId
          ? { ...m, managed: true, status: "scanning" as const }
          : m
      )
    );
    toast({
  ...
  const securityScoreDistribution = [
    {
      range: "90-100",
      count: models.filter((m) => m.securityScore >= 90).length,
    },
    {
      range: "70-89",
      count: models.filter((m) => m.securityScore >= 70 && m.securityScore < 90)
        .length,
    },
    {
      range: "50-69",
      count: models.filter((m) => m.securityScore >= 50 && m.securityScore < 70)
        .length,
    },
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Secure catalog of AI models with behavioral baselines and
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {models.filter((m) => m.managed).length} managed,{" "}
                  {models.filter((m) => !m.managed).length} shadow
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {Math.round(
                    models.reduce((acc, m) => acc + m.securityScore, 0) /
                      models.length
                  )}
                </div>
                <p className="text-xs text-muted-foreground">
                  <TrendingUp className="inline h-3 w-3 text-green-500" /> +5%
                  from last week
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-orange-500">
                  {models.filter((m) => m.driftScore > 10).length}
                </div>
                <p className="text-xs text-muted-foreground">
            ...
            <TabsContent value="catalog" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Secure catalog of protected AI models
                  </CardDescription>
                </CardHeader>
            ...
            <TabsContent value="scanning" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Model security checks and poisoning detection
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="rounded-md border">
            ...
            <TabsContent value="baselines" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Per-model behavioral profiling and drift detection
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                      ...
                      <CardHeader>
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <CardDescription>
                              Baseline established: {baseline.baselineDate}
                            </CardDescription>
                          </div>
                          <Badge
                            variant={
                              baseline.currentDrift > 10
                                ? "destructive"
                                : "outline"
                            }
                          >
            ...
            <TabsContent value="versions" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Model versions with semantic diffs
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                          ...
                          <div className="grid grid-cols-3 gap-4">
                            {version.semanticDiff.added.length > 0 && (
                              <div>
                                ...
                                <ul className="space-y-1">
                                  {version.semanticDiff.added.map(
                                    (item, idx) => (
                                      <li
                                        key={idx}
                            ...
                            {version.semanticDiff.removed.length > 0 && (
                              <div>
                                ...
                                <ul className="space-y-1">
                                  {version.semanticDiff.removed.map(
                                    (item, idx) => (
                                      <li
                                        key={idx}
                                        className="text-xs text-muted-foreground"
                            ...
                            {version.semanticDiff.modified.length > 0 && (
                              <div>
                                ...
                                <ul className="space-y-1">
                                  {version.semanticDiff.modified.map(
                                    (item, idx) => (
                                      <li
                                        key={idx}
                                        className="text-xs text-muted-foreground"
            ...
            <TabsContent value="shadow" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Detect unmanaged and unauthorized models
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-muted-foreground mt-1">
                          {models.filter((m) => !m.managed).length} unmanaged
                          model(s) detected in production without security
                          scanning
                        </div>
                      </div>
                    </div>
                      ...
                      .map((model) => (
                        <Card key={model.id} className="border-red-500/50">
                          ...
                          <CardContent className="space-y-4">
                            ...
                            <div className="flex gap-2">
                              <Button
                                onClick={() => handleRegisterModel(model.id)}
                              >
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Model security health overview
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      <PieChart>
                        <Pie
                          data={[
                            ...
                            {
                              name: "Active",
                              value: models.filter((m) => m.status === "active")
                                .length,
                            },
                          ]}
                          cx="50%"
          ...
          <Dialog open={showModelDialog} onOpenChange={setShowModelDialog}>
            <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto hide-scrollbar">
              <DialogHeader>
                ...
                <DialogDescription>
                  Model details and security information
                </DialogDescription>
              </DialogHeader>
              {selectedModel && (
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-medium">
                        {selectedModel.securityScore}/100
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-muted-foreground">
                  ...
                  <div>
                    ...
                    <Progress
                      value={selectedModel.securityScore}
                      className="h-2"
                    />
                  </div>
          ...
          <Dialog open={showVulnDialog} onOpenChange={setShowVulnDialog}>
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Security vulnerability information and mitigation
                </DialogDescription>
              </DialogHeader>
              {selectedVulnerability && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">
                      {selectedVulnerability.detected}
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <Button
                      onClick={() =>
                        handleMitigateVuln(selectedVulnerability.id)
                      }
                    >
                      <Shield className="mr-2 h-4 w-4" />
                      Apply Mitigation
          ...
          >
            <DialogContent className="max-w-3xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Detailed behavioral metrics and drift analysis
                </DialogDescription>
              </DialogHeader>
              {selectedBaseline && (
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-medium">
                        {selectedBaseline.currentDrift.toFixed(1)}%
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-4 gap-4">
                    <div>
                      ...
                      <div className="text-xl font-bold">
                        {selectedBaseline.metrics.accuracy}%
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-muted-foreground">
                      ...
                      <div className="text-xl font-bold">
                        {selectedBaseline.metrics.latency}ms
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-muted-foreground">
                      ...
                      <div className="text-xl font-bold">
                        {selectedBaseline.metrics.tokenUsage}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-muted-foreground">
                      ...
                      <div className="text-xl font-bold">
                        {selectedBaseline.metrics.errorRate}%
                      </div>
                    </div>
                  </div>
                </div>
