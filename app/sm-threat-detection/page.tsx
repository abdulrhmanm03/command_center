  ...
  const [customRules, setCustomRules] = useState([
    {
      ...
      description:
        "Flag sessions with >5 turns showing escalating privilege requests",
      enabled: true,
      conditions: [
        ...
        <div className="space-y-6 p-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Behavioral semantics scanning with LLM-based classifiers and
              custom rule builder
            </p>
          </div>
                    ...
                    <div className="flex gap-2">
                      <Select value={typeFilter} onValueChange={setTypeFilter}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="adversarial_input">
                            Adversarial Input
                          </SelectItem>
                          <SelectItem value="pii_leakage">
                            PII Leakage
                          </SelectItem>
                          <SelectItem value="model_extraction">
                            Model Extraction
                          </SelectItem>
                        </SelectContent>
                      </Select>
                        ...
                        >
                          <div className="flex-1 space-y-2">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <Badge
                                variant="outline"
                                className={getTypeColor(threat.type)}
                              >
                    ...
                    <div className="space-y-4">
                      <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {selectedThreat.metadata.endpoint}
                          </p>
                        </div>
                        <div>
                          <label className="text-sm font-medium">User ID</label>
                          <p className="text-sm text-muted-foreground">
                            {selectedThreat.metadata.userId}
                          </p>
                        </div>
                        <div>
                          <label className="text-sm font-medium">
                      ...
                      <div className="flex gap-2">
                        <Button
                          onClick={() => handleCreateIncident(selectedThreat)}
                        >
                          <FileText className="mr-2 h-4 w-4" />
                          Create Incident
                        </Button>
                        <Button
                          variant="outline"
                          onClick={() => handleAddToBlocklist(selectedThreat)}
                        >
                        ...
                        <Button
                          variant="outline"
                          onClick={() =>
                            handleMarkFalsePositive(selectedThreat)
                          }
                        >
            ...
            <TabsContent value="engine" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure core scanning engine and behavioral semantics
                    analysis
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Scan all inputs/outputs in real-time
                        </p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Enable behavioral semantics analysis
                        </p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Automatically block high-confidence threats
                        </p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => handleTestDetector("engine")}
                    >
            ...
            <TabsContent value="injection" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    LLM-based classifiers for direct and indirect injection
                    detection (OWASP LLM01)
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Detect direct prompt manipulation attempts
                        </p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Detect injections via external content
                        </p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Automatically block detected injections
                        </p>
                      </div>
                      <Switch
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Using ProtectAI's DeBERTa for high-accuracy injection
                        detection
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        <Slider
                          value={[
                            engineConfig.promptInjection.confidenceThreshold *
                              100,
                          ]}
                          onValueChange={([value]) =>
                            setEngineConfig({
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => handleTestDetector("prompt-injection")}
                    >
                      <Play className="mr-2 h-4 w-4" />
                      Test Scanner
                    </Button>
            ...
            <TabsContent value="behavioral" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Session analysis for jailbreaks, escalation, and multi-turn
                    manipulations
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Enable user session behavioral analysis
                        </p>
                      </div>
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setEngineConfig({
                            ...engineConfig,
                            behavioralProfiling: {
                              ...engineConfig.behavioralProfiling,
                              enabled: checked,
                            },
                          })
                        }
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        checked={
                          engineConfig.behavioralProfiling.sessionAnalysis
                        }
                        onCheckedChange={(checked) =>
                          setEngineConfig({
                            ...engineConfig,
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Detect jailbreak attempts and patterns
                        </p>
                      </div>
                      <Switch
                        checked={
                          engineConfig.behavioralProfiling.jailbreakDetection
                        }
                        onCheckedChange={(checked) =>
                          setEngineConfig({
                            ...engineConfig,
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        checked={
                          engineConfig.behavioralProfiling.escalationTracking
                        }
                        onCheckedChange={(checked) =>
                          setEngineConfig({
                            ...engineConfig,
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Analyze patterns across multiple turns
                        </p>
                      </div>
                      <Switch
                        checked={
                          engineConfig.behavioralProfiling.multiTurnAnalysis
                        }
                        onCheckedChange={(checked) =>
                          setEngineConfig({
                            ...engineConfig,
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      <Slider
                        value={[
                          engineConfig.behavioralProfiling.anomalyThreshold *
                            100,
                        ]}
                        onValueChange={([value]) =>
                          setEngineConfig({
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Sensitivity for detecting behavioral anomalies
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => handleTestDetector("behavioral")}
                    >
                      <Play className="mr-2 h-4 w-4" />
                      Test Profiling
                    </Button>
            ...
            <TabsContent value="semantic" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Toxicity, hallucination, bias, and PII detection
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setEngineConfig({
                            ...engineConfig,
                            semanticDetectors: {
                              ...engineConfig.semanticDetectors,
                              toxicityEnabled: checked,
                            },
                          })
                        }
                      />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        checked={
                          engineConfig.semanticDetectors.hallucinationEnabled
                        }
                        onCheckedChange={(checked) =>
                          setEngineConfig({
                            ...engineConfig,
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        <Slider
                          value={[
                            engineConfig.semanticDetectors.toxicityThreshold *
                              100,
                          ]}
                          onValueChange={([value]) =>
                            setEngineConfig({
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            setEngineConfig({
                              ...
                              semanticDetectors: {
                                ...engineConfig.semanticDetectors,
                                hallucinationThreshold: value / 100,
                              },
                            })
                          }
                          max={100}
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => handleTestDetector("semantic")}
                    >
                      <Play className="mr-2 h-4 w-4" />
                      Test Detectors
                    </Button>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription>
                        Create behavioral threshold rules for specific attack
                        patterns
                      </CardDescription>
                    </div>
            ...
            <TabsContent value="analytics" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Performance metrics and effectiveness of detection systems
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {Object.entries(analytics).map(([key, data]) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <Badge
                            variant={
                              data.accuracy > 90 ? "default" : "secondary"
                            }
                          >
