  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">2,472</div>
          <p className="text-xs text-muted-foreground">+8% from avg</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-success">Auto-mitigated</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-success">Avg detection time</p>
        </CardContent>
      </Card>
    </div>
  )
