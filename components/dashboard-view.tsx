...
import { Shield, AlertTriangle, CheckCircle2, Activity, TrendingUp, TrendingDown } from "lucide-react"
      ...
      setStats((prev) =>
        prev.map((stat) => {
          ...
          if (stat.title === "Threats Blocked") {
            ...
            return {
              ...stat,
              value: shouldIncrease ? stat.value + Math.floor(Math.random() * 3) + 1 : stat.value,
            }
          }
          return stat
        }),
  ...
  return (
    <div className="space-y-8 p-6 lg:p-8 text-white">
      <div className="space-y-1">
        ...
        <p className="text-gray-400">Real-time AI pipeline protection and threat intelligence</p>
      </div>
            ...
            >
              ...
              <div className="relative z-10">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <Icon className={`h-8 w-8 ${stat.iconColor} drop-shadow-md`} />
                </CardHeader>
                <CardContent>
